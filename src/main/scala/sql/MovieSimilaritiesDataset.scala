...
/*
  TODO:
    - discard bad ratings
    - try other similarity metrics (e.g. Pearson Correlation Coefficient ...)
    - adjust threshold for min co-raters or min score
    - invent a new similarity metric that takes the # of co-raters into account
    - use genre information in u.items to boost scores movies in the same genre
 */
